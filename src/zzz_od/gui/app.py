...
def main() -> None:
    ...
    # Apply language setting before any UI is created so all widgets render in the correct language
    if _ctx.custom_config.ui_language == UILanguageEnum.AUTO.value.value:
